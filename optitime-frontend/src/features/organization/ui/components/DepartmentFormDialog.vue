    ...
    <div class="d-grid gap-3">
      ...
      <div class="d-flex justify-content-end gap-2 pt-2">
        ...
        <AppButton :disabled="!canEdit" @click="$emit('save')">
          {{ t('pages.organization.actions.saveDepartment') }}
        </AppButton>
      </div>
    </div>
  </AppDialog>
...
const title = computed(() =>
  props.isEditing
    ? t('pages.organization.form.editDepartmentTitle')
    : t('pages.organization.form.createDepartmentTitle'),
)
</script>
